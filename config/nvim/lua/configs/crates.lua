return function()
  local icons = {
    diagnostics = require("custom.icons").get("diagnostics", true),
    git = require("custom.icons").get("git", true),
    misc = require("custom.icons").get("misc", true),
    ui = require("custom.icons").get("ui", true),
    kind = require("custom.icons").get("kind", true),
  }
